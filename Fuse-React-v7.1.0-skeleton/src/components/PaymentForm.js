...
export default function PaymentForm() {
    ...
    return (
        <>
        {!success ? 
        <form className="pay" style={{background:"white",height: "300px" }} onSubmit={handleSubmit}>
            <fieldset n className="FormGroup">
                <div className="FormRow">
                    <CardElement style={{marginLeft:"500px"}} options={CARD_OPTIONS}/>
                </div>
            </fieldset>
            <button class="button">
  <span class="button__text">
    <span>b</span><span>u</span>y</span>
    ...
    <g id="wallet">
      ...
      <path d="M148.16,343.22a6,6,0,0,0-6,6v92a6,6,0,0,0,12,0v-92A6,6,0,0,0,148.16,343.22Z" fill="#323c44" />
        ...
        :
       <div>
           <h2>You just bought a course congrats this is the best decision of you're life</h2>
